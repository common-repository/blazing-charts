...
/**
 * Plugin Name: Blazing Charts
 * Plugin URI: http://blazingspider.com/plugins/blazing-charts
 * Description: The plugin introduces a new post type for "Graph Scripts", and by
 *    adding a shortcode, it lets to insert the chart from one of several Charting Libraries
 * Version: 1.0.6
	...
	public function register_post_type()
	{
		$args = array(
			'labels' => array(
				...
				'all_items'          => __( 'All Chart Snippets', 'blazing-charts' ),
...
//				break;
	...
	public function register_d3_scripts() {
		$lib_path = BC_PLUGIN_PATH .  "js/d3js/d3.min.js";
		$lib_url = BC_PLUGIN_URL .  "js/d3js/d3.min.js";
		//$lib_path = str_replace('\\', '/', $lib_path);
		if ($this->options['d3_cdn'] === '1' || !file_exists($lib_path) ) {
			$lib_url = "//cdnjs.cloudflare.com/ajax/libs/d3/3.5.6/d3.min.js";
		}
